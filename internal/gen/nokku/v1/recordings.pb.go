...
const file_nokku_v1_recordings_proto_rawDesc = "" +
	...
	"\x0fDeleteRecording\x12 .nokku.v1.DeleteRecordingRequest\x1a!.nokku.v1.DeleteRecordingResponse\"?\x82\xd3\xe4\x93\x029*7/v1/workspaces/{workspace_id}/recordings/{recording_id}B\x96\x01\n" +
