...
const file_nokku_v1_workspace_proto_rawDesc = "" +
	...
	"\x18SubscribeWorkspaceEvents\x12).nokku.v1.SubscribeWorkspaceEventsRequest\x1a*.nokku.v1.SubscribeWorkspaceEventsResponse\"9\x82\xd3\xe4\x93\x020\x12./v1/workspaces/{workspace_id}/events:subscribe\x90\x02\x010\x01B\x95\x01\n" +
