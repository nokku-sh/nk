...
const file_nokku_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x13nokku/v1/auth.proto\x12\bnokku.v1\x1a\x1bbuf/validate/validate.proto\x1a\x16nokku/v1/account.proto\"v\n" +
	...
	"\x04name\x18\x03 \x01(\tR\x04name2\xd0\x05\n" +
	"\vAuthService\x12A\n" +
	"\bRegister\x12\x19.nokku.v1.RegisterRequest\x1a\x1a.nokku.v1.RegisterResponse\x128\n" +
	"\x05Login\x12\x16.nokku.v1.LoginRequest\x1a\x17.nokku.v1.LoginResponse\x12b\n" +
	"\x13LoginWithBackupCode\x12$.nokku.v1.LoginWithBackupCodeRequest\x1a%.nokku.v1.LoginWithBackupCodeResponse\x12;\n" +
	"\x06Logout\x12\x17.nokku.v1.LogoutRequest\x1a\x18.nokku.v1.LogoutResponse\x12S\n" +
	"\x0eForgotPassword\x12\x1f.nokku.v1.ForgotPasswordRequest\x1a .nokku.v1.ForgotPasswordResponse\x12P\n" +
	"\rResetPassword\x12\x1e.nokku.v1.ResetPasswordRequest\x1a\x1f.nokku.v1.ResetPasswordResponse\x12J\n" +
	"\vVerifyEmail\x12\x1c.nokku.v1.VerifyEmailRequest\x1a\x1d.nokku.v1.VerifyEmailResponse\x12_\n" +
	"\x12ResendVerification\x12#.nokku.v1.ResendVerificationRequest\x1a$.nokku.v1.ResendVerificationResponse\x12O\n" +
	"\vDiscoverSSO\x12\x1c.nokku.v1.DiscoverSSORequest\x1a\x1d.nokku.v1.DiscoverSSOResponse\"\x03\x90\x02\x01B\x90\x01\n" +
	"\fcom.nokku.v1B\tAuthProtoP\x01Z4github.com/nokku-sh/nk/internal/gen/nokku/v1;nokkuv1\xa2\x02\x03NXX\xaa\x02\bNokku.V1\xca\x02\bNokku\\V1\xe2\x02\x14Nokku\\V1\\GPBMetadata\xea\x02\tNokku::V1b\beditionsp\xe8\a"
