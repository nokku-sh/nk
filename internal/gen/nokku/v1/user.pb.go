...
const file_nokku_v1_user_proto_rawDesc = "" +
	...
	"\x11RevokeUserSession\x12\".nokku.v1.RevokeUserSessionRequest\x1a#.nokku.v1.RevokeUserSessionResponse\")\x82\xd3\xe4\x93\x02#*!/v1/account/sessions/{session_id}B\x90\x01\n" +
